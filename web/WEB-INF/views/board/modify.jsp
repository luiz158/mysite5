				...
				<form class="board-form" method="post" action="${pageContext.servletContext.contextPath }/board/modify">
					...
					<table class="tbl-ex">
						...
						<tr>
							...
							<td>
								<textarea id="content" name="content">${fn:replace(boardVo.content, newLine, "<br/>") }
								</textarea>
							</td>
						</tr>
					</table>
					<div class="bottom">
						<a href="${pageContext.servletContext.contextPath }/board/list?page_no=${sessionScope.pageNo }">취소</a>
